    ...
    public class BoletoBancario : System.Web.UI.Control
    {
        ...
        public string GeraHtmlReciboSacado()
        {
            try
            {
                ...
                if (Boleto.Banco.Codigo == 104)
                    html.Append(Html.ReciboSacadoParte3Caixa104);
                else
                ...
                // Caixa (104)
                if (Boleto.Banco.Codigo == 104)
                    html.Append(Html.ReciboSacadoParte7Caixa104);
                else
        ...
        public string GeraHtmlReciboCedente()
        {
            try
            {
                ...
                // Caixa (104)
                if (Boleto.Banco.Codigo == 104)
                    html.Append(Html.ReciboCedenteParte3Caixa104);
                else
                ...
                // Caixa (104)
                if (Boleto.Banco.Codigo == 104)
                    html.Append(Html.ReciboCedenteParte5Caixa104);
                else
                ...
                // Caixa (104)
                if (Boleto.Banco.Codigo == 104)
                    html.Append(Html.ReciboCedenteParte12Caixa104);
                else
        ...
        private string MontaHtml(string urlImagemLogo, string urlImagemBarra, string imagemCodigoBarras)
        {
            ...
            #region Implementação para o Banco do Brasil
                ...
                .Replace("@QUANTIDADE", (Boleto.QuantidadeMoeda == 0 ? "" : (Boleto.Banco.Codigo == 104 && Boleto.QuantidadeMoeda == 1 ? "" : Boleto.QuantidadeMoeda.ToString())))
